...
\begin{center}
    ...
    Гурьеву Сергею Александровичу, % нужно указать в дательном падеже (задание кому?)
...
на тему «Разработка веб-приложения для магазина музыкальных инструментов с системой каталога и личными кабинетами пользователей»
...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 1.1. Обзор существующих программных продуктов по теме работы                              & 10                 & 12.04.2026    &                     \\ \hline
    ...
    Задача 2.1. Анализ целевой аудитории                                                             & 5                                                                    & 26.04.2026    &                     \\ \hline
    Задача 2.2. Описание функциональности приложения (диаграмма вариантов использования, user story) & 7                  & 30.04.2026    &                     \\ \hline
    Задача 2.3. Проектирование модели данных (ER-диаграмма, логическая и физическая схемы БД)        & 8                       & 10.05.2026    &                     \\ \hline
    ...
    Задача 3.1. Разработка базовой структуры приложения и вёрстка шаблонов страниц & 8 &          20.05.2026 & \\ \hline
    Задача 3.2. Реализация аутентификации и авторизации пользователей & 7 &                                  24.05.2026 & \\ \hline
    Задача 3.3. Реализация CRUD-интерфейса для товаров, пользователей и заказов & 7 &                 27.05.2026 & \\ \hline
    Задача 3.4. Реализация каталога товаров и корзины покупок (агрегирование данных) & 12 &       31.05.2026 & \\ \hline
    Задача 3.5. Реализация загрузки файлов (изображения товаров и фотографии к отзывам) & 6 &  06.06.2026 & \\ \hline

    \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 4. Оформление итогов работы}}                                                                               \\ \hline
    Задача 4.1. Создание Git-репозитория с кодом проекта                                             & 3                    & 16.04.2026    &                     \\ \hline
